...
if ( ! function_exists( 'escape_room_posted_on' ) ) :
	/**
	...
	function escape_room_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'escape-room' ),
...
if ( ! function_exists( 'escape_room_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function escape_room_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'escape-room' ),
...
if ( ! function_exists( 'escape_room_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function escape_room_entry_footer() {
...
if ( ! function_exists( 'escape_room_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function escape_room_post_thumbnail() {
