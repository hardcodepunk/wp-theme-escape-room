...
foreach ($rooms as $room) : ?>
  ...
  <img
    ...
    class="w-full h-screen object-cover transition-transform duration-500 group-hover:scale-105"
  >
  <div class="absolute inset-0 bg-black/50"></div>

  <!-- Centered content -->
  <div class="absolute inset-0 flex flex-col items-center justify-center text-center text-white space-y-4 px-6">
    <h3 class="text-2xl font-bold uppercase"><?php echo esc_html($room['title']); ?></h3>
    <p class="text-sm opacity-80">Description</p>

    <!-- Cube CTA -->
    <a href="#booking"
       class="relative group inline-block w-[160px]"
