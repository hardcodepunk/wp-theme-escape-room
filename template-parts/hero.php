 ...
 * Hero section (splash)
 *
 * Displays the full-screen hero with background, heading and cube CTA
 *
 * @package Escape_Room
 */
?>
...
>
  ...
  <div class="relative z-10 flex flex-col items-center justify-center h-full text-center text-white space-y-12">
    <div>
      <h1 class="leading-tight flex flex-col items-center font-thin uppercase text-8xl">
        Let me out
      </h1>
      <p class="mt-4 text-lg uppercase font-thin">
        Escape from our puzzle rooms in the heart of Brussels.
      </p>
    </div>
  </div>
  ...
  <a
    ...
    class="absolute z-20 left-1/2 -translate-x-1/2 bottom-[4%] group inline-block w-[290px]
           ...
           after:top-[80%] after:w-px after:bg-white
           after:h-[calc(100%-64%)]"
