...
<main id="primary" class="site-main">
  ...
  <h1 class="text-6xl font-light tracking-widest leading-tight">
  LET<br>ME<br>OUT
</h1>

    <p class="mt-4 text-lg">Escape from our puzzle rooms in the heart of Brussels.</p>
    
<a href="#booking" class="mt-8 inline-block bg-black text-white px-6 py-3 rounded-md font-thin hover:bg-gray-800 transition">
  LET ME IN
</a>
