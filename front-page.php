...
<main id="primary" class="site-main">
  ...
  <section class="relative h-screen bg-cover bg-center" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/hero.png');">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center text-white">
      ...
      <a href="#booking"
         class="group relative mt-12 inline-block w-full max-w-[290px]"
        ...
        <svg
          ...
          <!-- BACK -->
          <polygon points="120,0 340,100 340,200 120,100" />

          <!-- CONNECTORS -->
          <line x1="40"  y1="40"  x2="120" y2="0"   />
          <line x1="260" y1="140" x2="340" y2="100" />
          <line x1="260" y1="240" x2="340" y2="200" />
          <line x1="40"  y1="140" x2="120" y2="100" />
        </svg>

        <span class="absolute inset-0 flex items-center justify-center
                     text-white font-thin tracking-[0.30em] text-[12px] pointer-events-none">
          LET ME IN
        </span>
      </a>
